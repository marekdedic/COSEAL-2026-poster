...
\begin{columns}[t]
			...
			\begin{center}
				\adjustbox{width=0.8\columnwidth}{%
					\begin{tabular}{lrrrrr}
						...
						\midrule
						Avg. rank		 & 3.78               & 4.44          & \underline{1.78}   & \textbf{1.67}      & 3.33               \\
						\bottomrule
					\end{tabular}
				}
			\end{center}
	...
	\begin{column}{\colwidth}
		...
		\begin{block}{Cross-RF Transfer Learning}
			...
			\vspace{0.2em}
			\begin{center}
				\includegraphics[width=\columnwidth]{images/cross-rf-overview/cross-rf-overview.pdf}
			\end{center}
		\end{block}
			...
			\begin{center}
				\adjustbox{width=0.5\columnwidth}{%
					\begin{tabular}{lrrr}
						...
						\midrule
						Avg.\ rank       & \underline{2.00}   & 2.22            & \textbf{1.78} \\
						\bottomrule
					\end{tabular}
				}
			\end{center}
		...
		\begin{columns}[c]
			\begin{column}{0.65\colwidth}
				\textbf{Full paper, poster \& blog post :}\\[0.4em]
